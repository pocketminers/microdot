...
class Parameter extends Hashable {
     ...
     * }`
     */
    constructor({ id = createIdentifier("Name", { prefix: "Parameter-" }), name = createIdentifier("Name", { prefix: "Parameter-" }), required = false, description = "A parameter", defaultValue, optionalValues = [] }) {
