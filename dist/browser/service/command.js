...
var Command = /** @class */ (function (_super) {
     ...
     */
    function Command(_a) {
        var _b = _a.id, id = _b === void 0 ? createIdentifier() : _b, _c = _a.name, name = _c === void 0 ? 'Base Command' : _c, _d = _a.description, description = _d === void 0 ? 'The Base Command Class' : _d, _e = _a.taskRunner, taskRunner = _e === void 0 ? defaultTaskRunner : _e, configuration = _a.configuration, _f = _a.properties, properties = _f === void 0 ? [] : _f, _g = _a.parameters, parameters = _g === void 0 ? [] : _g, _h = _a.args, args = _h === void 0 ? [] : _h;
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.taskRunner(instance, this.config.toRecord())];
